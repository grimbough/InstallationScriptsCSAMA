...
deps = c("ALL", "AnnotationDbi", "AnnotationForge", "AnnotationHub", "AnnotationHub ", "ArrayExpress", "BBmisc", "BH", "BRAIN", "BSgenome", "BSgenome.Celegans.UCSC.ce2", "BSgenome.Dmelanogaster.UCSC.dm3", "BSgenome.Hsapiens.NCBI.GRCh38", "BSgenome.Hsapiens.UCSC.hg19", "BSgenome.Hsapiens.UCSC.hg19 ", "BSgenome.Mmusculus.UCSC.mm10", "BSgenome.Scerevisiae.UCSC.sacCer2", "BatchJobs", "Biobase", "BiocCheck", "BiocGenerics", "BiocInstaller", "BiocParallel", "BiocParallel ", "BiocStyle", "Biostrings", "Biostrings ", "BradleyTerry2", "Cairo", "Category", "ComplexHeatmap", "Cubist", "DBI", "DESeq", "DESeq2", "DEXSeq", "DT", "DelayedArray", "EnsDb.Hsapiens.v75", "EnsDb.Hsapiens.v86", "ExperimentHub", "FDb.UCSC.tRNAs", "FNN", "Formula", "GEOquery", "GGally", "GO.db", "GOstats", "GSEABase", "GenomeInfoDb", "GenomicAlignments", "GenomicAlignments ", "GenomicFeatures", "GenomicFiles", "GenomicFiles ", "GenomicRanges", "GenomicRanges ", "GetoptLong", "Glimma", "GlobalOptions", "Gviz", "Gviz ", "Heatplus", "Hiiragi2013", "HilbertCurve", "Hmisc", "Homo.sapiens", "IHW", "IPPD", "IRanges", "IRanges ", "IRdisplay", "KEGG.db", "KEGGREST", "KEGGgraph", "KMsurv", "KernSmooth", "Lahman", "MALDIquant", "MALDIquantForeign", "MASS", "MLInterfaces", "MLmetrics", "MSGFgui", "MSGFplus", "MSnID", "MSnbase", "MassSpecWavelet", "Matrix", "ModelMetrics", "MultiAssayExperiment", "OrgMassSpecR", "OrganismDbi", "PFAM.db", "PoiClaClu", "ProtGenerics", "R.cache", "R.utils", "R6", "RANN", "RColorBrewer", "RCurl", "RISmed", "RMySQL", "RNAseqData.HNRNPC.bam.chr14", "RNAseqData.HNRNPC.bam.chr14 ", "ROC", "RPostgreSQL", "RSQLite", "RSclient", "RSelenium", "RUnit", "RaggedExperiment", "Rcpp", "RcppArmadillo", "Rdisop", "ReportingTools", "RforProteomics", "Rgraphiz", "Rgraphviz", "Rsamtools", "Rsamtools ", "Rserve", "Rsubread", "S4Vectors", "SNPlocs.Hsapiens.dbSNP141.GRCh38", "ShortRead", "SparseM", "SummarizedExperiment", "TxDb.Athaliana.BioMart.plantsmart22", "TxDb.Dmelanogaster.UCSC.dm3.ensGene", "TxDb.Hsapiens.UCSC.hg18.knownGene", "TxDb.Hsapiens.UCSC.hg19.knownGene", "TxDb.Hsapiens.UCSC.hg19.knownGene ", "TxDb.Hsapiens.UCSC.hg19.lincRNAsTranscripts", "TxDb.Hsapiens.UCSC.hg38.knownGene", "TxDb.Mmusculus.UCSC.mm10.knownGene", "TxDb.Mmusculus.UCSC.mm9.knownGene", "UpSetR", "VariantAnnotation", "VariantAnnotation ", "VennDiagram", "XML", "XVector", "abind", "acepack", "affy", "affydata", "airway", "annotate", "assertthat", "base64enc", "beeswarm", "biocViews", "biomaRt", "biomaRt ", "biovizBase", "bitops", "bladderbatch", "boot", "broom", "caTools", "car", "caret", "chemometrics", "chipseq", "chron", "circlize", "class", "clue", "cluster", "cmprsk", "codetools", "colorspace", "corrplot", "covr", "crosstalk", "curatedMetagenomicData", "curl", "data.table", "datasets", "deldir", "dendextend", "dendsort", "devtools", "dichromat", "digest", "doParallel", "dplyr", "dsQTL", "dtplyr", "e1071", "earth", "edgeR", "ellipse", "ensembldb", "erma", "evaluate", "extrafont", "faahKO", "fastICA", "fastcluster", "fdrtool", "ff", "ffbase", "fission", "foreach", "foreign", "formatR", "futile.logger", "gQTLBase", "gQTLstats", "gWidgets", "gam", "genefilter", "geneplotter", "geosphere", "geuvPack", "geuvStore2", "ggbeeswarm", "ggbio", "ggplot2", "ggplot2 ", "ggplot2movies", "ggpubr", "ggthemes", "glmnet", "globaltest", "gplots", "grDevices", "graph", "graphics", "grid", "gridExtra", "gtable", "gtools", "hexbin", "hgu133a.db", "hgu95av2.db", "hgu95av2cdf", "hgu95av2probe", "highr", "hms", "hom.Hs.inp.db", "hpar", "htmlTable", "htmltools", "htmlwidgets", "httr", "hwriter", "igraph", "impute", "imputeLCMD", "interactiveDisplay", "intergraph", "ipred", "isobar", "iterators", "itertools", "jpeg", "jsonlite", "kernlab", "klaR", "knitr", "knitr ", "lars", "lattice", "latticeExtra", "lazyeval", "ldblock", "limma", "lintr", "listviewer", "locfit", "lpsymphony", "lubridate", "magick", "magrittr", "mapproj", "maps", "maptools", "markdown", "matrixStats", "maxstat", "mclust", "mda", "methods", "mgcv", "mice", "microbenchmark", "microbenchmark ", "mirbase.db", "misc3d", "mlbench", "mouse4302.db", "msdata", "msmsEDA", "msmsTests", "multcomp", "multtest", "mvtnorm", "mzID", "mzR", "ncdf4", "network", "nlme", "nnet", "norm", "nycflights13", "org.At.tair.db", "org.Hs.eg.db", "org.Hs.eg.db ", "org.Mm.eg.db", "org.Sc.sgd.db", "orientlib", "pROC", "pRoloc", "pRolocdata", "packagedocs", "pamr", "pander", "parallel", "party", "pasilla", "pasillaBamSubset", "pcaMethods", "pheatmap", "phyloseq", "plotly", "pls", "plyr", "png", "preprocessCore", "prettydoc", "progress", "proxy", "pryr", "purrr", "pvclust", "quantreg", "qvalue", "rTANDEM", "randomForest", "reactome.db", "readBrukerFlexData", "readr", "reshape", "reshape2", "rgl", "rlang", "rmarkdown", "rms", "rnaseqGene", "rols", "roxygen2", "rpart", "rprojroot", "rpx", "rstudioapi", "rtracklayer", "rtracklayer ", "sampling", "scagnostics", "scales", "sf", "shiny", "shinyFiles", "shinyjs", "showtext", "showtextdb", "slam", "sna", "snow", "snpStats", "splines", "spls", "statmod", "stats", "stats4", "stringi", "stringr", "subselect", "superpc", "survMisc", "survival", "survminer", "sva", "svglite", "synapter", "synapterdata", "sysfonts", "tables", "tcltk", "testit", "testthat", "tibble", "tidyr", "tidyverse", "tiff", "tikzDevice", "tkWidgets", "tools", "topGO", "tsne", "tufte", "tximport", "tximportData", "utils", "vcd", "vipor", "viridis", "viridisLite", "vsn", "waldronlab/MultiAssayExperiment", "waveslim", "webshot", "withr", "xcms", "xkcd", "xlsx", "xtable", "yaml", "yriMulti", "zebrafishRNASeq", "zlibbioc", "zoo")
