...
if(!LOCAL) {
    ...
    if( buildPackages ){
        ...
        write_PACKAGES("additionalPackages/bin/windows/contrib/3.5", verbose=TRUE, type="win.binary")
        write_PACKAGES("additionalPackages/bin/macosx/mavericks/contrib/3.5/", verbose=TRUE, type="mac.binary")
    }
